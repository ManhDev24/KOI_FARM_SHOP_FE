      ...
      <div className='Navbar grid  grid-cols-6 w-[full] h-[150px]'>
        ...
        <div className='categories col-span-4 h-[150px]'>
          <ul className='flex flex-row  items-center h-[150px]'>
            ...
            <li className='me-x'>
              <Button type="primary" danger className='cate-font ps-1 w-auto h-[42px] box-content'>
                Tin tức
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M10.0002 12.5L5.8335 8.33331H14.1668L10.0002 12.5Z" fill="#EA4444" />
                </svg>
            ...
            <li className='me-x'>
              <Button type="primary" danger className='cate-font  w-[42px] h-[42px] box-border'>
                ...
              </Button>
            </li>
            <li className='me-x'>
              <div class="relative flex">
                <input
                  type="search"
                  className="relative m-0 block flex-auto left-[40px] border rounded-[10px] border-solid border-[#e24242]   ps-10 py-[0.25rem] text-base leading-[1.6]  outline-none   placeholder:text-neutral-500  focus:border-primary focus:shadow-inset  dark:placeholder:text-[#FA4444]"
                  placeholder="Tìm Kiếm"
                  aria-label="Search"
                  id="exampleFormControlInput2"
                  aria-describedby="button-addon2" />
                <span
                  className="absolute left-9 top-1 items-center whitespace-nowrap px-3 py-[0.25rem] text-surface dark:border-neutral-400 dark:text-[#FA4444] [&>svg]:h-5 [&>svg]:w-5"
                  id="button-addon2">
            ...
            <div style={{ width: '100%', height: '100%', position: 'relative', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-end', display: 'inline-flex' }}>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="31" height="37" viewBox="0 0 31 37" fill="none" className='absolute right-[5px]' >
