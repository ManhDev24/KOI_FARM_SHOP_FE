...
const Navbar = () => {
  ...
  // Check if user data exists in local storage to maintain login state
  useEffect(() => {
  ...
  const handleGoogleLoginSuccess = (credentialResponse) => {
    ...
    localStorage.setItem("user", JSON.stringify(decoded)); // Save user data to local storage
  ...
  return (
    <>
      <div className='Navbar grid grid-cols-6   w-full h-[150px] lg:w-full lg:h-[150px] md:h-[200px]  sm:h-[300px] sm:col-span-1'>
        <div className='w-full h-full flex flex-col justify-center col-span-1 md:col-span-1 sm:col-span-12 items-center'>
          <div className='logo w-[90px]  h-[90px] container ms-[50px]'>
            ...
            <div style={{ width: 98, color: '#EA4444', fontSize: 20, fontFamily: 'Arial', fontWeight: '700', textTransform: 'uppercase', wordWrap: 'break-word' }}>KOI FARM</div>
          </div>
        </div>
        ...
        <div className='categories  lg:col-span-3 lg:h-[150px] md:w-[300px] md:h-[200px] md:col-span-1 sm:h-[200px]'>
          ...
          <ul className='flex flex-row items-center md:h-[200px] lg:h-[150px] md:display'>
            ...
            <li className='me-x'>
              <Button type="primary" danger className='my-0 mx-auto cate-font ps-1  w-[192px]  h-[42px] box-border flex justify-center align-top pe-1'>
                <span className='w-[178px] h-[30px]'>
                  Hỗ trợ khách hàng
                </span>
              </Button>
            </li>
