      ...
      <div className='Navbar grid grid-cols-6   w-full h-[150px] '>
        ...
        <div className='categories col-span-4 h-[150px]'>
          <ul className='flex flex-row items-center h-[150px]'>
            ...
            <li className='me-x w-[42px] h-[42px] box-border'>
              <Button type="primary" danger className='cate-font w-[42px] h-[42px] box-border flex justify-center items-center'>
                <span className='h-[42px] justify-center'>...</span>
              </Button>
            </li>
            <li className='me-x'>
              <div className="relative flex">
                <input
                  ...
                  />
                <span
                  className="absolute left-10 top-[7px] items-center whitespace-nowrap px-3 py-[0.25rem] text-surface dark:border-neutral-400 dark:text-[#FA4444] [&>svg]:h-5 [&>svg]:w-5"
                  id="button-addon2">
        ...
        <div className='w-full h-full flex justify-center items-center'>
          <Link to="cart" > 
            <button className='relative left-[-30px] flex justify-end items-center'> <div style={{ width: '100%', height: '100%', position: 'relative', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-end', display: 'inline-flex' }}>
