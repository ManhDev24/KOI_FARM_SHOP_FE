...
import { Breadcrumb, Button, Form, Input, Row, Select, Upload } from 'antd'
import TextArea from 'antd/es/input/TextArea';
import React, { useState } from 'react'
import { useForm } from 'react-hook-form';
import { Link } from 'react-router-dom'
import * as Yup from 'yup'
// import requestConsignment from './requestConsignment.css'
...
const RequestConsignment = () => {
    ...
    const handleUploadKoiImage = ({ file }) => {
        ...
        console.log(file); // You can process or preview the file here
        // Return false if you want to prevent automatic upload
        return false;
    };
    ...
    const handleSelectGender = (value) => {
        setSelectedGender(value); // Update state with the selected value
        console.log("Selected gender:", value); // Log the selected value
    };
    const handleSelectPureBred = (value) => {
        setSelectedPureBred(value); // Update state with the selected value
        console.log("Độ thuần chủng đã chọn:", value); // Log the selected value
    };
    return (
        <>
            ...
            <div className='flex flex-col items-center'>
                ...
                <div className="w-[950px]  mt-10 form-container">
                    <Form onFinish={onFinish}
                        ...
                        autoComplete="off">
                        <div className="w-[950px] h-[2530px] px-20 py-[50px]   placeholder: bg-white border border-[#FA4444] justify-between items-start  grid grid-cols-2">
                            ...
                            <div className=" col-span-1 left w-[311px] h-[1387px] flex-col justify-start items-start gap-[250px] inline-flex">
                                <div className="self-stretch h-[300px] flex-col justify-center items-center gap-2.5 flex">
                                    <div className="flex-col justify-center items-center gap-2.5 flex">
                                        <Form.Item labelCol={{ span: 24 }}  // Specify the width of the label
                                            wrapperCol={{ span: 24 }}
                                            label="Ảnh Koi" name="koiImg" className="flex">
                                            <Upload
                                                name="koiImg"
                                                listType="picture"
                                                className="flex flex-col items-center" // Changed to flex-col for better layout
                                                showUploadList={false}
                                                onChange={handleUploadKoiImage}
                                                beforeUpload={() => false} // Prevent automatic upload
                                            >
                                                <div className="mt-2 w-[220px] h-[220px] bg-white rounded-lg border-2 border-[#e94444] flex items-center justify-center">
                                                    {/* Optional: Add an icon or text to indicate that this is the upload area */}
                            ...
                            <div className=" col-span-1 right flex-col justify-start items-start gap-10 inline-flex">
                                <div className="self-stretch h-[2215.65px] flex-col justify-start items-start gap-[25px] flex">
                                    <div className="self-stretch w-full h-[1269.65px] px-2.5 py-5  border-2 border-gray-200  flex-col justify-start items-start gap-[25px] flex  relative right-5">
                                        ...
                                        <div className="w-[464px] justify-start items-start gap-2.5 inline-flex">
                                            ...
                                            >
                                                <Input placeholder='190' className='w-[100px] ms-10'></Input>
                                            </Form.Item>                                        </div>
