    ...
    <div className=" group flex-col w-full items-center justify-center my-[80px]">
      ...
      <div className='w-full flex justify-center'>
        <div className="flex- w-[950px] flex-col my-[80px]">
              ...
              {fishDetails && (
                <>
                  <div className='w-[592px] border-2 border-[#FA4444] ms-[12px] '>
                    <div className='flex justify-center mt-4 font-bold '>MÔ TẢ CHI TIẾT</div>
          ...
          <div >
            <h1 className='flex justify-center font-bold font- border-2 border-[#FA4444]' style={{fontSize:'24px' , fontFamily: 'Merriweather, serif' }}>
              Gợi ý Koi
            </h1>
